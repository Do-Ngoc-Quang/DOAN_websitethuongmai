          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                ...
                <h3 class="card-header text-center">Contacts</h3>
                  ...
                  <table class="table">
                    ...
                    @foreach($contacts as $contact)
                      <tr class="table-default">
                        <td><i class="fab fa-sketch fa-lg text-warning me-3"></i>{{$contact->id}}</td>
                        ...
                        <!-- Delete modal -->
                        <div class="modal fade" id="modal-delete-{{$contact->id}}" tabindex="-1" aria-hidden="true">
