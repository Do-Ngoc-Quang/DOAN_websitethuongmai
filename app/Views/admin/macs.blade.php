          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                ...
                <h3 class="card-header text-center">Macs</h3>
                ...
                data-bs-target="#modal-create-mac">Create new Mac</button>
                  ...
                  <table class="table">
                    ...
                    @foreach($macs as $mac)
                      <tr class="table-default">
                        <td><i class="fab fa-sketch fa-lg text-warning me-3"></i>{{$mac->id}}</td>
                        <td><strong>{{$mac->name}}</strong></td>
                        <td>{{$mac->price}} $</td>
                        <td>
                          <img src="{{ asset('storage/upload_macs/' . $mac->picture) }}" alt="picture" 
                        ...
                        <td>
                          ...
                          data-bs-toggle="modal"
                          data-bs-target="#modal-edit-{{$mac->id}}">Edit</button>

                          <button type="submit"
                          class="btn btn-outline-danger"
                          data-bs-toggle="modal"
                          data-bs-target="#modal-delete-{{$mac->id}}">Delete</button>
                        </td>
                    ...
                    <!-- Edit modal -->
                    <div class="modal fade" id="modal-edit-{{$mac->id}}" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-xl" role="document">
                            <div class="modal-content">
                                    ...
                                    <form action="/mac-edit/{{$mac->id}}" method="POST">
                                        @csrf
                                        @method('PUT')
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col mb-3">
                                                            ...
                                                            <input type="text" id="name" name="name" value="{{$mac->name}}" class="form-control"
                                                    ...
                                                    <div class="row">
                                                        <div class="col mb-3">
                                                            ...
                                                            <input type="text" id="price" name="price" value="{{$mac->price}}" class="form-control"
                                                    ...
                                                    <div class="row mb-3">
                                                        <div>
                                                            ...
                                                            <textarea class="form-control" rows="5" name="description"
                                                                id="description">{{$mac->description}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <!-- Delete modal -->
                        <div class="modal fade" id="modal-delete-{{$mac->id}}" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="/mac-delete/{{$mac->id}}" method="POST">
                                    @csrf
                                    @method('DELETE')
              ...
              <!-- Modal - Create - Mac -->
              <div class="modal fade" id="modal-create-mac" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-xl" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel4">Add MAC</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <form action="/mac.create" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-body">
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            ...
                                            <div class="row mb-3">
                                                <label class="col-sm-2 col-form-label" for="basic-default-company">Picture Mac</label>
                                                <div class="col-sm-10">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary">Add new Mac</button>
                                </div>
                            </form>
                        </div>
                    </div>
