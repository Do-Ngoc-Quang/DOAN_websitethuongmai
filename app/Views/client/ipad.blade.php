...
<body class="animsition">
	...
	<div class="bg0 m-t-23 p-b-140">
		<h3 class="	text-center mb-5">ipad</h3>
		<div class="container">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2 border border-info rounded p-3 ">
						...
						<div class="block2-pic hov-img0">
							<img src="{{ asset('storage/upload_ipads/' . $ipad->picture) }}" alt="IMG-PRODUCT">

							<!-- <a href="" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
								Quick View
							</a> -->
							<a class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
								<form action="/cart.add.ipad" method="POST">
									@csrf
									<input type="hidden" value="ipad" name="type">
									<input type="hidden" value="{{$ipad->id}}" name="id">
									<input type="hidden" value="{{$ipad->name}}" name="name">
									<input type="hidden" value="{{$ipad->price}}" name="price">
									<input type="hidden" value="1" name="quantity">
									<input type="hidden" value="{{$ipad->picture}}" name="picture">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="/ipad-{{$ipad->id}}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									{{$ipad->name}}
								</a>
